    ...
    public class ChromeBrowserWatch : IBrowserWatcher
    {
        ...
        public void StartWatch(IntPtr handle)
        {
            try
            {
                ...
                var condtionName = automation.CreatePropertyCondition(30005, "Google Chrome");
            ...
            return await Task.Run(() =>
               {
                   ...
                   try
                   {
                       ...
                       var condtionAccessKey = automation.CreatePropertyCondition(30007, "Ctrl+L");
